    ...
    `${JSON.stringify(
      {
        ...
        categoryUnassignedCounts: report.summary.categoryUnassignedCounts,
        recognizedCounts: report.summary.recognizedCounts,
        unassignedCount: report.summary.unassignedCount,
