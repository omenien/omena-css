...
export const EVIDENCE_UNRESOLVED_WRITE_WITNESS_LEDGER = [
  {
    ...
    reason:
      "the documentation writer passes the Map-iterated relativePath into assertGeneratedFile, whose absolutePath write target the static evaluator does not resolve across the helper parameter",
  },
  {
    commandId: "documentation-reference-surface",
  ...
  },
  {
    ...
    reason:
      "the documentation writer passes the module-level sdkGuidePath literal into assertGeneratedFile, whose absolutePath write target the static evaluator does not resolve across the helper parameter",
  },
  {
    commandId: "documentation-reference-surface",
    outputPath: "docs/vscode-extension.md",
    reason:
      "the documentation writer passes the module-level vscodeGuidePath literal into assertGeneratedFile, whose absolutePath write target the static evaluator does not resolve across the helper parameter",
  },
  {
    commandId: "documentation-reference-surface",
    outputPath: "rust/crates/omena-cli/README.md",
    reason:
      "the documentation writer passes the module-level cliReadmePath literal into assertGeneratedFile, whose absolutePath write target the static evaluator does not resolve across the helper parameter",
  },
  {
  ...
  },
  {
    ...
    reason:
      "the compatibility writer passes the module-level browserThresholdsPath literal into writeText, whose path.join write target the static evaluator does not resolve across the helper parameter",
  },
  {
    commandId: "transform-target-compatibility",
    outputPath: "rust/crates/omena-transform-target/data/native-stage2-coverage.json",
    reason:
      "the compatibility writer passes the module-level nativeStage2CoveragePath literal into writeText, whose path.join write target the static evaluator does not resolve across the helper parameter",
  },
  {
    commandId: "transform-target-compatibility",
    outputPath: "rust/crates/omena-transform-target/data/pass-feature-bindings.toml",
    reason:
      "the compatibility writer passes the module-level passFeatureBindingsPath literal into writeText, whose path.join write target the static evaluator does not resolve across the helper parameter",
  },
