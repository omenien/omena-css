...
fn declares_runtime_backed_selected_query_adapter_capabilities() {
    ...
    assert!(
        summary
            .runner_commands
            .iter()
            .any(|command| command.command == "input-scss-evaluator-control-flow-oracle-corpus")
    );
    assert!(
        summary
            .runner_commands
            .iter()
            .any(|command| command.command == "input-native-css-evaluator")
    );
    assert!(
        summary
            .runner_commands
    ...
    assert!(
        summary
            .runner_commands
            .iter()
            .any(|command| command.command == "input-static-lif-exports")
    );
    assert!(
        summary
            .runner_commands
