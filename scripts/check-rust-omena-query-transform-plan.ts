...
assert.equal(
  ...
  "omena-transform-target-data-v0:thresholds-2026-07-27:bindings-2026-07-27",
);
assert.equal(
...
assert.deepEqual(ieLightDarkEvidence.lastVerified, ["2026-07-27"]);
...
assert.equal(chrome122LightDarkTarget.matchedThreshold?.lastVerified, "2026-07-27");
