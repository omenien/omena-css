...
import type * as EngineInputBuilder from "../server/engine-host-node/src/engine-input-v2";
...
type EngineV2ContractIdlCompatibility = [
  ...
  AssertAssignable<ReturnType<typeof EngineInputBuilder.buildEngineInputV2>, EngineInputV2Json>,
