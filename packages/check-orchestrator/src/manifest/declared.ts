...
export const DECLARED_CHECK_GATES = [
  ...
  {
    id: "tooling/evidence-scan-surfaces",
    kind: "gate",
    scope: "tooling",
    packageTarget: "check:evidence-scan-surfaces",
    ciTier: "verify",
    ciGroup: "verify",
    tags: ["evidence", "scan-surface", "generated-artifact-drift"],
  },
  {
    id: "tooling/evidence-affected-map",
    kind: "gate",
    scope: "tooling",
    packageTarget: "check:evidence-affected-map",
    ciTier: "verify",
    ciGroup: "verify",
    tags: ["evidence", "affected", "writer-registry"],
  },
  {
  ...
  {
    id: "release/check/release-rehearsal-workflow",
    kind: "gate",
    scope: "release",
    command: ["node", "--import", "tsx", "./scripts/check-release-rehearsal-workflow.ts"],
    tags: ["release", "workflow", "rehearsal"],
    ciTier: "closure-fast",
    ciGroup: "closure-fast",
  },
  {
    id: "release/rehearsal/crate-dry-run",
    kind: "gate",
    scope: "release",
    command: ["node", "--import", "tsx", "./scripts/check-release-rehearsal-crate-dry-run.ts"],
    tags: ["release", "rehearsal", "crates", "scheduled"],
    ciTier: "scheduled",
    ciGroup: "release-rehearsal",
    timeoutMinutes: 90,
  },
  {
    id: "release/rehearsal/notes",
    kind: "gate",
    scope: "release",
    command: ["node", "--import", "tsx", "./scripts/check-release-rehearsal-notes.ts"],
    tags: ["release", "rehearsal", "notes", "scheduled"],
    ciTier: "scheduled",
    ciGroup: "release-rehearsal",
    timeoutMinutes: 15,
  },
  {
    id: "release/rehearsal/npm-pack",
    kind: "gate",
    scope: "release",
    command: ["node", "--import", "tsx", "./scripts/check-release-rehearsal-npm-pack.ts"],
    tags: ["release", "rehearsal", "npm", "scheduled"],
    ciTier: "scheduled",
    ciGroup: "release-rehearsal",
    timeoutMinutes: 45,
  },
  {
    id: "release/rehearsal/lifecycle",
    kind: "bundle",
    scope: "release",
    deps: [
      "release/check/release-notes",
      "release/check/release-print-sensitive-evidence",
      "release/check/release-tag-grammar",
      "release/check/release-workflow-job-classification",
      "rust/published-crate-surface-register",
    ],
    tags: ["release", "rehearsal", "lifecycle", "scheduled"],
    ciTier: "scheduled",
    ciGroup: "release-rehearsal",
    timeoutMinutes: 30,
  },
  {
    id: "release/rehearsal/environment-protection",
    kind: "gate",
    scope: "release",
    command: ["node", "--import", "tsx", "./scripts/check-release-environment-protection.ts"],
    tags: ["release", "rehearsal", "environment", "scheduled"],
    ciTier: "scheduled",
    ciGroup: "release-rehearsal",
    timeoutMinutes: 5,
  },
  {
    id: "release/rehearsal/retirement",
    kind: "gate",
    scope: "release",
    command: ["node", "--import", "tsx", "./scripts/check-release-rehearsal-retirement.ts"],
    tags: ["release", "rehearsal", "retirement", "scheduled"],
    ciTier: "scheduled",
    ciGroup: "release-rehearsal",
    timeoutMinutes: 5,
  },
  ...
  },
  {
    ...
    deps: [
      ...
      "rust/frame-refresh-runtime-disposition",
      "rust/style-hover-index-policy",
      "rust/sif-attestation-feature",
      "release/check/release-tag-grammar",
      "release/check/release-rehearsal-workflow",
      "release/check/release-print-sensitive-evidence",
      "release/check/release-workflow-job-classification",
  ...
  {
    id: "rust/precision-floor",
    kind: "gate",
    scope: "rust",
    packageTarget: "rust/precision-floor",
    tags: ["precision", "manual"],
    ciTier: "manual",
    ciReason:
      "Rust diagnostics maintainers retain the legacy spelling-based precision checker as an advisory manual diagnostic while its assertions are counted for successor instrumentation.",
    timeoutMinutes: 20,
  },
  ...
  declaredClosurePackageGate("rust/omena-resolver/identity-index-callers", "gate", "rust"),
  ...
  declaredClosurePackageGate("rust/omena-write-safety", "gate", "rust"),
  {
    ...
    kind: "gate",
    scope: "rust",
    packageTarget: "check:rust-precision-authority",
    tags: ["rust-workspace", "precision", "census"],
    ciTier: "rust-workspace",
    ciGroup: "rust-workspace",
    timeoutMinutes: 5,
  },
  {
    id: "rust/dual-pin-product-bytes",
    kind: "gate",
    scope: "rust",
    packageTarget: "check:dual-pin-product-bytes",
    tags: ["rust", "byte-identity", "manual"],
    ciTier: "manual",
    ciReason: "relay-time dual-pin byte-identity arm; baseline pin is relay-scoped",
  },
  {
  ...
  },
  {
    ...
    kind: "gate",
    scope: "rust",
    packageTarget: "rust/fs-capability-ban",
    tags: ["rust-workspace", "filesystem", "capability"],
    ciTier: "rust-workspace",
    ciGroup: "rust-workspace",
    timeoutMinutes: 30,
  },
  {
    id: "rust/fs-acquisition-census",
    kind: "gate",
    scope: "rust",
    packageTarget: "rust/fs-acquisition-census",
    tags: ["rust-workspace", "filesystem", "census"],
    ciTier: "rust-workspace",
    ciGroup: "rust-workspace",
    timeoutMinutes: 30,
  },
  ...
  declaredClosurePackageGate("release/check/release-print-sensitive-evidence", "gate", "release"),
  declaredClosurePackageGate(
    "release/check/release-workflow-job-classification",
    "gate",
    "release",
  ...
  {
    id: "rust/omena-query/public-surface-all-features",
    kind: "gate",
    scope: "rust",
    packageTarget: "rust/omena-query/public-surface-all-features",
    tags: ["closure-fast", "public-api", "query", "all-features"],
    ciTier: "closure-fast",
    ciGroup: "closure-fast",
  },
  {
    id: "rust/omena-query/dead-reexports",
    kind: "gate",
    scope: "rust",
    packageTarget: "rust/omena-query/dead-reexports",
    tags: ["closure-fast", "public-api", "query", "deprecation"],
    ciTier: "closure-fast",
    ciGroup: "closure-fast",
  },
  {
    id: "rust/omena-query/visibility-experiment",
    kind: "gate",
    scope: "rust",
    packageTarget: "rust/omena-query/visibility-experiment",
    tags: ["closure-fast", "public-api", "query", "visibility"],
    ciTier: "closure-fast",
    ciGroup: "closure-fast",
  },
  {
  ...
  {
    id: "rust/sif-attestation-feature",
    kind: "gate",
    scope: "rust",
    packageTarget: "rust/sif-attestation-feature",
    tags: ["closure-fast", "bridge", "sif", "features", "semver"],
    ciTier: "closure-fast",
    ciGroup: "closure-fast",
  },
  {
  ...
  },
  {
    ...
    kind: "gate",
    scope: "rust",
    packageTarget: "rust/omena-bundler/linked-emission-default-surfaces",
