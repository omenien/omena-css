...
| `crateTrainVersion`            | `0.5.0`                                                                                                                                                              | `rust/Cargo.toml` workspace package                         |
...
expanded public surfaces cannot be released as a patch. The current `0.5.0`
train likewise advances the minor line for reviewed pre-1.0 public-shape,
runtime-contract, and default-emission changes.
