...
const bundlerAliasFixtureRequirements = [
  ...
  "extracts_vite_aliases_from_top_level_config_identifier",
  "extracts_object_aliases_from_top_level_alias_identifier",
  "extracts_array_aliases_from_top_level_alias_identifier",
  "extracts_aliases_from_top_level_resolve_identifier",
  "marks_dynamic_alias_entries_unrecognized",
  "marks_dynamic_alias_identifier_unrecognized",
  "marks_dynamic_resolve_identifier_unrecognized",
  ...
  JSON.stringify(
    {
      ...
      bundlerConfigAliasExtraction: {
        ...
        covers: [
          ...
          "top-level-config-identifier-aliases",
          "top-level-alias-identifier-literals",
          "top-level-resolve-identifier-literals",
          "dynamic-alias-entry-markers",
          "dynamic-alias-identifier-markers",
          "dynamic-resolve-identifier-markers",
