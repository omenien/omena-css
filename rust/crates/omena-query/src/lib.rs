...
pub use omena_cross_file_summary::{
    ...
    ReverseDependencyIndexV0, UnifiedHypergraphHyperedgeV0, apply_reverse_dependency_delta_v0,
    collect_directed_graph_cycles, collect_directed_graph_cycles_with_work_cap,
    collect_directed_graph_sccs, collect_hypergraph_transitive_closure_paths,
...
pub use omena_query_core::{
    ...
    ExpressionSemanticsQueryFragmentsV0, ExternalStringTypeFactsV0,
