...
fn execution_runtime_normalizes_zero_length_units_with_property_context() {
    ...
    assert_eq!(execution.mutation_count, 22);
    assert_eq!(
        execution.output_css,
...
fn execution_runtime_compresses_line_style_shorthands() {
    ...
    assert_eq!(
        execution.output_css,
        r#".a { border-top: 1px solid red; } .b { border: none; } .c { outline: solid; } .d { outline: 1px red; } .e { border-inline: none!important; } .f { border: 1px solid red; } .mixed { border-top-width: 1px; color: blue; border-top-style: solid; border-top-color: red; }"#
    );
    assert_eq!(
        execution.executed_pass_ids,
        vec!["shorthand-combining", "print-css"]
