...
#[deprecated(
    since = "0.6.0",
    note = "unused query-facade re-export; import from the owning crate; removal requires a separately reviewed pre-1.0 semver decision"
)]
pub use omena_bridge::{
...
pub use omena_cross_file_summary::{
    ...
    OmenaCrossFileSummaryRawEdgeKindV0, OmenaQueryUnifiedCrossFileHypergraphV0,
    OmenaQueryUnifiedCrossFileMonotoneFactPropagationHypergraphV0,
    OmenaUnifiedHypergraphConnectivityOracle, collect_directed_graph_cycles,
    ...
    collect_reachable_node_ids_bitset, parse_cross_file_summary_node_role_v0,
    parse_cross_file_summary_raw_edge_kind_v0, reverse_dependency_closure_v0,
};
#[allow(deprecated)]
#[deprecated(
    since = "0.4.0",
...
pub use omena_query_core::{
    ClassValueFlowAnalysisV0, ClassValueFlowIncrementalAnalysisV0,
    ...
    ExpressionSemanticsQueryFragmentsV0, IncrementalInvalidationPriorityPlanV0,
    Lin01ProvenanceSemiringV0, OmenaQueryExpressionDomainIncrementalFlowAnalysisEntryV0,
    OmenaQueryExpressionDomainSelectorPrecisionV0,
    OmenaQueryExpressionDomainSelectorProjectionEntryV0, OmenaQueryFragmentBundleV0,
    OmenaResolverSourceResolutionRuntimeIndexV0, PolynomialProvenanceProjectionV0,
    PolynomialProvenanceTermV0, PolynomialProvenanceVariableV0,
    ...
    narrow_abstract_property_value_for_pseudo_state, split_top_level_whitespace_value_components,
};
#[allow(deprecated)]
#[deprecated(
    since = "0.4.0",
