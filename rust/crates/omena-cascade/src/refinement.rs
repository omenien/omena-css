...
mod tests {
    ...
    const EXPECTED_AUTHORED_PROPERTY_PROOFS_RS_SHA256: [u8; 32] = [
        0xd0, 0x64, 0x6f, 0x3c, 0x1a, 0x2d, 0x2c, 0x84, 0xa7, 0xca, 0xde, 0xb3, 0x82, 0x1c, 0xaa,
        0xe3, 0x2d, 0xa1, 0xcb, 0x14, 0xd2, 0xca, 0x8c, 0x4d, 0xce, 0x84, 0x8d, 0x43, 0xf1, 0x83,
        0xfb, 0x6e,
    ];

    #[test]
    fn authored_property_proofs_rs_change_is_explicitly_pinned() {
        let digest = sha256(include_bytes!("proofs.rs"));
        assert_eq!(digest, EXPECTED_AUTHORED_PROPERTY_PROOFS_RS_SHA256);
    }
