...
use omena_cross_file_summary::{
    UnifiedHypergraphEdgeKindV0, UnifiedHypergraphHyperedgeV0, collect_reachable_node_ids,
    collect_reachable_node_ids_bitset,
};
...
library_benchmark_group!(
    ...
    benchmarks =
        reachability_delta_visits_less_work_than_batch,
