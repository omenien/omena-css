...
use call_resolution::max_call_stack_depth_observed;
...
use return_candidates::collect_scss_return_candidates;
use symbol_candidates::call_return_candidate_from_sass_symbol;
