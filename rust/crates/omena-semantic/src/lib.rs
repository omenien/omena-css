...
pub use sass_module_graph::{
    ...
    SassModuleGraphEdgeFactV0, SassModuleUseConfigurationRequestV0, SassModuleVariableOverrideV0,
    ...
    prefix_sass_forward_exports, resolve_sass_module_effective_variable_overrides,
