...
mod tests {
    ...
    fn boundary_reports_pinned_sources_and_p0_policy() {
        ...
        assert_eq!(summary.manifest_entry_count, 7);
        assert_eq!(summary.p0_entry_count, 6);
        assert_eq!(summary.source_linked_entry_count, 7);
        assert_eq!(summary.webref_entry_count, 7);
