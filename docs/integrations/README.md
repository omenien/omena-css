...
| -------- | --------------------------- | ------------------------- | ------------------------------ |
| CLI      | scripts and CI              | process filesystem        | `omena-cli@0.5.0` on crates.io |
| Rust LSP | editors                     | editor workspace          | GitHub and extension bundles   |
| NAPI     | Node hosts                  | caller and native process | `@omena/napi@0.5.0`            |
| WASM     | browsers and portable hosts | caller-supplied memory    | `@omena/wasm@0.5.0`            |
| Vite     | development and builds      | Vite module graph         | `@omena/vite-plugin@0.5.0`     |
| PostCSS  | PostCSS pipelines           | PostCSS file context      | `@omena/postcss-plugin@0.5.0`  |
