...
for (const requiredSource of [
  ...
  "CalcDimensionDiagnosticKindV0",
  "summarize_dimension_vector_domain_v0",
  "summarize_calc_dimension_diagnostics_v0",
  "omena-refinement.cascade-dimensional-refinement-bridge",
  "omena-refinement.dimension-vector-domain",
  "omena-refinement.calc-dimension-diagnostics",
  "m6DimensionalRefinementBridgeSubstrate",
  "dimension-vector-domain-v0",
  "calc-dimension-diagnostics-v0",
  ...
  "calc_dimension_diagnostics_classify_fixture_mismatches_without_unit_fork",
]) {
...
for (const requiredReadme of [
  ...
  "research-staged dimensional refinement substrate only",
  ...
  `${JSON.stringify(
    {
      ...
      dimensionVectorDomainReady: true,
      calcDimensionDiagnosticsReady: true,
