...
- **Transform source-map provenance** - transform provenance nodes now expose source/generated span mapping, and identity print output emits line-level source-map segments before later mutation printers add finer split spans.
